            ...
            <div class="col-md-9 col-lg-10">
                <div class="mb-3">
                    <h2 class="fw-bold text-info fs-4">
                        <i class="fas fa-plus me-2"></i> Cadastrar Categoria
                    </h2>
                    <p class="text-secondary small">Adicione uma nova categoria de produtos</p>
                </div>
                ...
                <div class="card border border-info border-opacity-25 rounded-3 shadow-sm">
                    <div class="card-header bg-info bg-opacity-10 border-0 rounded-top-3 py-2">
                        <h6 class="mb-0 text-info"><i class="fas fa-tag me-1"></i> Dados da Categoria</h6>
                    </div>
                    <div class="card-body p-3">
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="descricao" class="form-control form-control-sm border border-info border-opacity-25 rounded-2" rows="3"><?php echo htmlspecialchars($_POST['descricao'] ?? ''); ?></textarea>
                                <div class="form-text text-secondary small">Descrição detalhada da categoria (opcional)</div>
                            </div>
                            
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="ativo" value="1" id="ativoSwitch" <?php echo (isset($_POST['ativo']) && $_POST['ativo'] == '1') || !isset($_POST['ativo']) ? 'checked' : ''; ?>>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-info text-white btn-sm rounded-2">
                                    <i class="fas fa-save me-1"></i> Cadastrar Categoria
                                </button>
                            </div>
                        </form>
                    </div>
