...
<body>
    ...
    <div class="col-md-2 sidebar">
        <div class="nav flex-column">
            ...
            <a class="nav-link active" href="cadastrar.php"><i class="fas fa-plus"></i> Novo Funcionário</a>
        </div>
    </div>
    
    <div class="col-md-10 main-content">
        <h2><i class="fas fa-plus"></i> Cadastrar Funcionário</h2>
                ...
                <form method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label>Salário</label>
                                <input type="text" name="salario" class="form-control money" placeholder="0,00">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label>Data Admissão *</label>
                                <input type="date" name="data_admissao" class="form-control" required value="<?php echo date('Y-m-d'); ?>">
                            </div>
                        </div>
                    </div>
