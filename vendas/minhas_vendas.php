        ...
        <div class="container-fluid px-4">
            ...
            <div class="ms-auto d-flex align-items-center gap-3">
                <span class="text-secondary">
                    ...
                    <?php echo isset($_SESSION['usuario_nome']) ? htmlspecialchars($_SESSION['usuario_nome']) : 'Vendedor'; ?>
                </span>
                <span class="badge bg-info bg-opacity-25 text-info px-3 py-2">
                    <i class="fas fa-tag me-1"></i> Vendedor
                </span>
        ...
        <div class="row g-3">
                ...
                <div class="card border border-info border-opacity-25 rounded-4 shadow-sm sticky-top" style="top: 20px;">
                    <div class="card-body p-0">
                        <div class="nav flex-column nav-pills p-3 gap-2">
                            ...
                            <a class="nav-link active bg-info bg-opacity-25 text-info fw-semibold rounded-3" href="minhas_vendas.php">
                                <i class="fas fa-chart-simple me-2"></i> Minhas Vendas
                            </a>
            ...
            <div class="col-md-9 col-lg-10">
                <div class="mb-3">
                    ...
                    <p class="text-secondary small">Acompanhe seu desempenho e histórico de vendas</p>
                </div>
                            ...
                            <div class="card-body p-2 p-md-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-info mb-0 fs-5"><?php echo isset($estatisticas['total_vendas']) ? $estatisticas['total_vendas'] : 0; ?></h4>
                                    </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="card border border-success border-opacity-25 rounded-3 shadow-sm">
                            <div class="card-body p-2 p-md-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <p class="text-secondary mb-0 small">Faturamento</p>
                                        <h4 class="fw-bold text-success mb-0 fs-6">R$ <?php echo isset($estatisticas['valor_total']) ? number_format($estatisticas['valor_total'], 2, ',', '.') : '0,00'; ?></h4>
                                    </div>
                            ...
                            <div class="card-body p-2 p-md-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h4 class="fw-bold text-info mb-0 fs-6">R$ <?php echo isset($estatisticas['ticket_medio']) ? number_format($estatisticas['ticket_medio'], 2, ',', '.') : '0,00'; ?></h4>
                                    </div>
                                    <div class="bg-info bg-opacity-10 rounded-circle p-2">
                    ...
                    <div class="col-6 col-md-3">
                        <div class="card border border-warning border-opacity-25 rounded-3 shadow-sm">
                            <div class="card-body p-2 p-md-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <p class="text-secondary mb-0 small">Clientes</p>
                                        <h4 class="fw-bold text-warning mb-0 fs-5"><?php echo isset($estatisticas['clientes_distintos']) ? $estatisticas['clientes_distintos'] : 0; ?></h4>
                                    </div>
                                    <div class="bg-warning bg-opacity-10 rounded-circle p-2">
                                        <i class="fas fa-users text-warning fs-6"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Gráfico de Vendas - mais compacto -->
                <?php if(isset($vendas_por_dia) && !empty($vendas_por_dia)): ?>
                <div class="card border border-info border-opacity-25 rounded-3 shadow-sm mb-3">
                    ...
                    <div class="card-body p-2">
                        <canvas id="vendasChart" height="60" style="max-height: 180px;"></canvas>
                    </div>
                </div>
                <?php endif; ?>
                
                <!-- Tabela de Vendas com métricas e indicadores -->
                <div class="card border border-info border-opacity-25 rounded-3 shadow-sm">
                    <div class="card-header bg-info bg-opacity-10 border-0 rounded-top-3 py-2 d-flex justify-content-between align-items-center">
                        <h6 class="mb-0 text-info"><i class="fas fa-history me-1"></i> Histórico de Vendas</h6>
                        <span class="badge bg-info bg-opacity-25 text-info">
                            <i class="fas fa-chart-simple me-1"></i> <?php echo isset($total) ? $total : 0; ?> vendas
                        </span>
                    </div>
                    <div class="card-body p-0">
                                    ...
                                    <?php if(isset($vendas) && !empty($vendas)): ?>
                                        <?php foreach($vendas as $venda): ?>
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-end small">R$ <?php echo number_format($venda['subtotal'], 2, ',', '.'); ?></td>
                                                <td class="text-end small text-danger">- R$ <?php echo number_format($venda['desconto'], 2, ',', '.'); ?></td>
                                                <td class="text-end fw-semibold text-success">R$ <?php echo number_format($venda['total'], 2, ',', '.'); ?></td>
                                                <td>
                                                    <?php 
                                                    $formas = [
                                                ...
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-outline-info btn-sm rounded-2 py-0 px-2" data-bs-toggle="modal" data-bs-target="#modalVenda<?php echo $venda['id']; ?>">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    
                                                    <!-- Modal Detalhes -->
                                                    <div class="modal fade" id="modalVenda<?php echo $venda['id']; ?>" tabindex="-1">
                                                        <div class="modal-dialog modal-dialog-centered modal-sm">
                                                            <div class="modal-content rounded-3 border border-info border-opacity-25">
                                                                ...
                                                                <div class="modal-body p-2">
                                                                    <?php
                                                                    $itensVenda = $pdo->prepare("
                                                                        SELECT iv.*, p.nome 
                                                                        FROM itens_venda iv
                                                                        JOIN produtos p ON iv.produto_id = p.id
                                                                        WHERE iv.venda_id = ?
                                                                    ");
                                                                    $itensVenda->execute([$venda['id']]);
                                                                    ?>
                                                                    <div class="table-responsive">
                                                                            ...
                                                                            <tbody>
                                                                                <?php foreach($itensVenda as $item): ?>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-end small">R$ <?php echo number_format($item['subtotal'], 2, ',', '.'); ?></td>
                                                                                    </tr>
                                                                                <?php endforeach; ?>
                                                                            </tbody>
                                                                            <tfoot>
                                                                                <tr class="border-top">
                                                                                    ...
                                                                                    <td class="text-end fw-bold text-success">R$ <?php echo number_format($venda['total'], 2, ',', '.'); ?></td>
                                                                                </tr>
                                                                            </tfoot>
                                                                         </table>
                                                                    </div>
                                    ...
                                    <?php for($i = 1; $i <= $totalPages; $i++): ?>
                                        <li class="page-item <?php echo $i == ($page ?? 1) ? 'active' : ''; ?>">
                                            <a class="page-link <?php echo $i == ($page ?? 1) ? 'bg-info border-info text-white' : 'text-info border-info border-opacity-25'; ?>" 
                                               href="?page=<?php echo $i; ?>&data_inicio=<?php echo isset($data_inicio) ? $data_inicio : date('Y-m-01'); ?>&data_fim=<?php echo isset($data_fim) ? $data_fim : date('Y-m-d'); ?>">
                                                <?php echo $i; ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'R$',
                    data: vendasData.map(item => parseFloat(item.total)),
