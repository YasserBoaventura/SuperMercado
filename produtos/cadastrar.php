...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("
            ...
            preco_compra, preco_venda, quantidade, quantidade_minima, unidade_medida, data_validade, localizacao)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
        ...
        // Log
        $log = $pdo->prepare("INSERT INTO logs (usuario_id, acao, tabela_afetada, registro_id, ip_address) VALUES (?, 'cadastrar', 'produtos', ?, ?)");
